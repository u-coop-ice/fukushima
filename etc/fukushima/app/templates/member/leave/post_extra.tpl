{if $k==1}<h4 class="page-header">お手続きについて</h4>{/if}

<div class="form-group" id="form-group_extra{$k}">
<label class="col-sm-3 control-label">
{$methods['extra'][$k]['title']|nl2br}{if $methods['extra'][$k]['use']==2}<span class="label label-danger">必須</span>{else}<span class="label label-default">任意</span>{/if}
</label>
<div class="col-sm-9">
...
{/if}
{if $methods['extra'][$k]['note']}<p class="help-block">{$methods['extra'][$k]['note']|nl2br}</p>{/if}
