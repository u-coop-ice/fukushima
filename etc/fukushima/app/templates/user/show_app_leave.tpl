...
<p class="">入力された内容が反映した{$category['denomination']}を以下URLからダウンロードできます。</p>
<p class=""><a class="btn btn-primary" href="{$init_url}app/{$app['component']}/?mode=link_pdf&code={$app['code']}" target="_blank" ><i class="fa fa-fw fa-file-pdf-o"></i>{$category['denomination']}</a></p>
