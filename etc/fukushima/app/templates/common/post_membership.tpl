...
" class="num form-control input-lg validate[{if $methods['membership']['use']==2}required,{/if}minSize[4],custom[onlyNumberSp]]" value="{$post['membership1']}"/>
</div>
...
" class="num form-control input-lg validate[{if $methods['membership']['use']==2}required,{/if}minSize[4],custom[onlyNumberSp]]" value="{$post['membership2']}" /></div>
<div class="pull-left"><p class="form-control-static">&#8194;&#8211;&#8194;</p></div>
<div class="pull-left"><input type="tel" id="membership3" name="membership3" maxlength="4" placeholder="半角4桁
" class="num form-control input-lg validate[{if $methods['membership']['use']==2}required,{/if}minSize[4],custom[onlyNumberSp]]" value="{$post['membership3']}" /></div>
<div class="clear"></div>
