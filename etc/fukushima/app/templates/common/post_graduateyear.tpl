...
<label class="col-sm-3 control-label">{$methods['graduateyear']['title']|default:"卒業予定年"}{if $methods['graduateyear']['use']==2}<span class="label label-danger">必須</span>{else}<span class="label label-default">任意</span>{/if}</label>
<div class="col-sm-9">


<input type="text" id="graduateyear" name="graduateyear" value="{$post['graduateyear']}" placeholder="" class="datetime form-control input-lg{if $methods['graduateyear']['use']==2} validate[required]{/if}">
