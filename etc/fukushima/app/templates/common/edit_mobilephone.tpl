...
<div class="col-sm-9">
<div class="pull-left">
<input type="text" id="mobilephone1" name="mobilephone1" class="form-control input-lg validate[{if $methods['mobilephone']['use']==2}required,{/if}custom[onlyNumberSp]]" maxlength="3" value="{$regist['mobilephone1']}" />
</div>
<div class="pull-left"><p class="form-control-static">&#8194;&#8211;&#8194;</p></div>
<div class="pull-left">
<input type="text" id="mobilephone2" name="mobilephone2" class="form-control input-lg validate[{if $methods['mobilephone']['use']==2}required,{/if}custom[onlyNumberSp]]" 
maxlength="4" value="{$regist['mobilephone2']}" />
</div>
<div class="pull-left"><p class="form-control-static">&#8194;&#8211;&#8194;</p></div>
<div class="pull-left">
<input type="text" id="mobilephone3" name="mobilephone3" class="form-control input-lg validate[{if $methods['mobilephone']['use']==2}required,{/if}custom[onlyNumberSp]]" maxlength="4" value="{$regist['mobilephone3']}" />
</div>
<div class="clear"></div>
