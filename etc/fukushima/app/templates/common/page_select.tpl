...
{if $is_prev_page}
{*<a class="prev page-numbers" href="{$self}?{if $url_query}{$url_query}&amp;{/if}page=1" data-icon="arrow-l" data-role="button" title="先頭ページ"><i class="fa fa-fast-backward"></i></a>*}
...
{*<a class="next page-numbers" href="{$self}?{if $url_query}{$url_query}&amp;{/if}page={$page_count}" data-icon="arrow-r" data-role="button" data-iconpos="right" title="最終ページ"><i class="fa fa-fast-forward"></i></a>*}
{/if}
