...
<div class="col-sm-9">
<input type="text" id="email" name="email" class="form-control input-lg validate[required,custom[email]]" maxlength="64" value="{$post['email']}" />
...
<div class="col-sm-9">
<input type="text" id="emailcfrm" name="emailcfrm" class="form-control input-lg validate[required,custom[email],equals[email]]" maxlength="64" value="{$post['emailcfrm']}" />
